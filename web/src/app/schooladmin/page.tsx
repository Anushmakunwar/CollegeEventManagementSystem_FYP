      ...
      <div className="flex-1 p-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <Link
              href="/schooladmin/faculties/new"
              className="p-6 bg-white shadow-md rounded-lg flex flex-col items-center hover:shadow-xl transition"
            >
              <FaBookReader className="text-4xl text-green-600" />
              <span className="mt-2 font-bold">Create Faculty</span>
              <p className="text-sm text-gray-500">
                Create a new Faculty in the School.
              </p>
            </Link>
            <Link
              href="/schooladmin/users"
              className="p-6 bg-white shadow-md rounded-lg flex flex-col items-center hover:shadow-xl transition"
            >
